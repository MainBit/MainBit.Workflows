...
namespace MainBit.Workflows.Forms {
    public class EmailForm : Component, IFormProvider {
        ...
        public void Describe(DescribeContext context) {
                ...
                shape => {
                    ...
                    var form = New.Form(
                        ...
                        _Type: New.FieldSet(
                            ...
                            _Attachments: New.Textbox(
                                Id: "Attachments",
                                Name: "Attachments",
                                Title: T("Email Attachments"),
                                Description: T("Specify a comma-separated list of email file attachments."),
                                Classes: new[] { "large", "text", "tokenized" })
                            ));
            ...
            context.Form("EmailAttachmentsActivity", formFactory);
        }
    ...
    public class EmailFormValidator : IFormEventHandler {
        ...
        public void Validating(ValidatingContext context) {
            if (context.FormName != "EmailAttachmentsActivity") return;

...
namespace MainBit.Workflows.Forms {
    public class EmailFromForm : Component, IFormProvider {
        private readonly IFeatureManager _featureManager;
        protected dynamic New { get; set; }

        public EmailFromForm(IShapeFactory shapeFactory,
        ...
        public void Describe(DescribeContext context) {
                    ...
                    var form = New.Form(
                        ...
                        _Type: New.FieldSet(
                            ...
                            _Sender: New.Textbox(
                                ...
                                Description: T("Specify a sender email addresses. To include a display name, use the following format: John Doe &lt;john.doe@outlook.com&gt;"),
            ...
            context.Form("EmailFromActivity", formFactory);
        }

    }

    public class EmailFromFormValidator : IFormEventHandler {
        ...
        public void Validating(ValidatingContext context) {
            if (context.FormName != "EmailFromActivity") return;

            var sender = context.ValueProvider.GetValue("Sender").AttemptedValue;
            ...
            {
                context.ModelState.AddModelError("Sender", T("You must provide a Sender.").Text);
            }
            ...
            // can be empty (for subscribe.ru) http://subscribe.ru/faq/faq1.html#byemail

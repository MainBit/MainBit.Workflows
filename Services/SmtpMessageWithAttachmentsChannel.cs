...
namespace MainBit.Workflows.Services {
    public class SmtpMessageWithAttachmentsChannel : Component, IAttachmentsSmtpChannel, IDisposable
    {
        ...
        public SmtpMessageWithAttachmentsChannel(
        ...
        public void Process(IDictionary<string, object> parameters) {
            ...
            var attachments = parameters["Attachments"] as string;
            var attachmentList = attachments.Split(new char[] { ';' }, StringSplitOptions.RemoveEmptyEntries).ToList();
            ...
            attachmentList.ForEach(x => mailMessage.Attachments.Add(new Attachment(x)));

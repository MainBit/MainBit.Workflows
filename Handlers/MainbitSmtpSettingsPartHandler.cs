...
namespace MainBit.Workflows.Handlers {
    ...
    public class MainbitSmtpSettingsPartHandler : ContentHandler {
        ...
        public MainbitSmtpSettingsPartHandler(IEncryptionService encryptionService)
        {
            T = NullLocalizer.Instance;
            Logger = NullLogger.Instance;

            _encryptionService = encryptionService;
            Filters.Add(new ActivatingFilter<MainbitSmtpSettingsPart>("Site"));

            OnLoaded<MainbitSmtpSettingsPart>(LazyLoadHandlers);

            OnInitializing<MainbitSmtpSettingsPart>((context, part) =>
            {
                part.Port = 25;
        ...
        void LazyLoadHandlers(LoadContentContext context, MainbitSmtpSettingsPart part)
        {
        ...
        protected override void GetItemMetadata(GetContentItemMetadataContext context) {
            ...
            context.Metadata.EditorGroupInfo.Add(new GroupInfo(T("Email MainBit")));
        }
    }
}